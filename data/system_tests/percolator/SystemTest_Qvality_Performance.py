...
pathToBinaries = "C:/Program Files (x86)/PERCOLATOR/bin"
pathToData = "D:/code/library/percolator/data"
pathToOutputData = "D:/code/library/percolator/data"
tmpDir = "D:/code/library/percolator/data"
success = True
