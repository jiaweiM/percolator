...
/**
 * 根据 scan number 将 pin 文件中的 PSMs 分为交叉验证中的 xval_fold 份。
 *
 ...
 */
void Scores::createXvalSetsBySpectrum(std::vector<Scores>& train, std::vector<Scores>& test,
	const unsigned int xval_fold, FeatureMemoryPool& featurePool) {
